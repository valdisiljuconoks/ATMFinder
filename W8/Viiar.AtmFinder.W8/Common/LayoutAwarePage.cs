...
namespace Viiar.AtmFinder.W8.Common
{
    ...
    /// </summary>
    [WebHostHidden]
    public class LayoutAwarePage : PageBase
    {
        /// <summary>
        ...
        ///   state changes.
        /// </summary>
        /// <param name="sender"> Instance of <see cref="Control" /> that supports visual state management corresponding to view states. </param>
        ...
        /// </summary>
        /// <param name="navigationParameter"> The parameter value passed to <see cref="Frame.Navigate(Type, Object)" /> when this page was initially requested. </param>
        /// <param name="pageState"> A dictionary of state preserved by this page during an earlier session. This will be null the first time a page is visited. </param>
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            var frameState = SuspensionManager.SessionStateForFrame(Frame);
            this._pageKey = "Page-" + Frame.BackStackDepth;
        ...
        private class ObservableDictionary<K, V> : IObservableMap<K, V>
        {
            ...
            public ICollection<K> Keys { get { return this._dictionary.Keys; } }
            ...
            public ICollection<V> Values { get { return this._dictionary.Values; } }
