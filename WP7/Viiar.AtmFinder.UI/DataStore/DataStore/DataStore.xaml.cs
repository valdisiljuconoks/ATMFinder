...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/Viiar.AtmFinder.UI;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string Header
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.Header;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.Header = value;
			}
		}
	}
}
