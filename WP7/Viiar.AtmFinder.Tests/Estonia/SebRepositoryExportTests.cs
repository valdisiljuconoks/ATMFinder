...
INSERT INTO [dbo].[Entity]
     ...
     VALUES
           ...
           ,'" + entity.ChainCode + @"'" + @"
           ,NULL" + //'https://public.sn2.livefilestore.com/y1p5_YspPNoGAtTPJ-2nRfewaaE0l482ZKz1tYcBg62O2c31rAYY7NMedeoQquUp3o9lAQ3OIdrA4VzpxRbrwrTTg/seb-details.png'
           ",NULL" + //https://public.sn2.livefilestore.com/y1pwxXFOcT0JPfDoU5qzYfW6vK4Sn2lHa3dcQKRjzbSXw1yp306f1x9pErty2Y1lek5LZf4B1Er0ikdSl4tfOePYg/seb-list.png'
           ", NULL)"); //"https://public.sn2.livefilestore.com/y1p5_YspPNoGAucTgeioIPa1vYjUa5ofpGLj8CunW-9mTtdQF1yUXC9_HAWpL5DX0MpRZEW2Mxz8W8spWyDQuQyzg/seb-map.png'
            }
        }
    }
    ...
    public class SebRepositoryResourceLocalFileReader : IResourceFileReader
    {
        ...
        {
            using (var fs = File.OpenRead(@"C:\Sources\AtmFinder\WP7\Dev\Viiar.AtmFinder.UI\Data\Estonia\seb.json"))
            {
